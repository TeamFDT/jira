...
package jiglib.vehicles {
	...
	public class JWheel {
		 ...
		 * radius: wheel radius
		 */
		public function setup(pos : Vector3D, axisUp : Vector3D, spring : Number = 0, travel : Number = 0, inertia : Number = 0, radius : Number = 0, sideFriction : Number = 0, fwdFriction : Number = 0, damping : Number = 0, numRays : int = 0) : void {
			_pos = pos;
			_axisUp = axisUp;
			_spring = spring;
			_travel = travel;
