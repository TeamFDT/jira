package jiglib.cof {
	public class JConfig {
		...
		// allowable value: FAST,NORMAL,ACCUMULATED
		public static var boxCollisionsType : String = "EDGEBASE";
		// allowable value: EDGEBASE or SORTBASE
		public static var rotationType : String = "DEGREES";
		// can be either RADIANS or DEGREES;
		public static var aabbDetection : Boolean = true;
		// if execute the aabb detection;
		public static var allowedPenetration : Number = 0.01;
		// How much penetration to allow
		...
		// change for detecting orientation changes during deactivation.
