package jiglib.geometry {
	...
	public class JBox extends RigidBody {
		...
		private var _edges : Vector.<EdgeData> = Vector.<EdgeData>([new EdgeData(0, 1), new EdgeData(3, 1), new EdgeData(2, 3), new EdgeData(2, 0), new EdgeData(4, 5), new EdgeData(5, 7), new EdgeData(6, 7), new EdgeData(4, 6), new EdgeData(7, 1), new EdgeData(5, 3), new EdgeData(4, 2), new EdgeData(6, 0)]);
		private var _face : Vector.<Object> = Vector.<Object>([[6, 7, 1, 0], [5, 4, 2, 3], [3, 1, 7, 5], [4, 6, 0, 2], [1, 3, 2, 0], [7, 6, 4, 5]]);
		...
		override public function getInertiaProperties(m : Number) : Matrix3D {
			return JMatrix3D.getScaleMatrix((m / 12) * (_sideLengths.y * _sideLengths.y + _sideLengths.z * _sideLengths.z), (m / 12) * (_sideLengths.x * _sideLengths.x + _sideLengths.z * _sideLengths.z), (m / 12) * (_sideLengths.x * _sideLengths.x + _sideLengths.y * _sideLengths.y))
		}
