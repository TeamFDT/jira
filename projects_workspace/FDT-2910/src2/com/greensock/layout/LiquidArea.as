	...
	public class LiquidArea extends AutoFitArea {
		...
		public static function createAround(target : DisplayObject, vars : Object = null, ...args) : LiquidArea {
			if (vars == null || typeof(vars) == "string") {
				...
				vars = {scaleMode:vars || "proportionalInside", hAlign:args[0] || "center", vAlign:args[1] || "center", crop:Boolean(args[2]), minWidth:args[4] || 0, minHeight:args[5] || 0, maxWidth:(isNaN(args[6]) ? 999999999 : args[6]), maxHeight:(isNaN(args[7]) ? 999999999 : args[7]), autoPinCorners:Boolean(args[8] != false), calculateVisible:Boolean(args[9]), liquidStage:args[10] || LiquidStage.getByStage(target.stage), reconcile:Boolean(args[11] != false), strict:Boolean(args[12])};
			}
