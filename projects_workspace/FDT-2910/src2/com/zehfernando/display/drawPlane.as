package com.zehfernando.display {
	...
	public function drawPlane(graphics : Graphics, bitmap : BitmapData, p1 : Point, p2 : Point, p3 : Point, p4 : Point) : void {
		...
		graphics.drawTriangles(Vector.<Number>([p1.x, p1.y, p2.x, p2.y, p3.x, p3.y, p4.x, p4.y]), Vector.<int>([0, 1, 2, 1, 3, 2]), Vector.<Number>([0, 0, (1 / ll2) * f, 1, 0, (1 / lr2), 0, 1, (1 / lr1), 1, 1, (1 / ll1) * f])// Magic
		);
	}
}
import flash.geom.Point;
