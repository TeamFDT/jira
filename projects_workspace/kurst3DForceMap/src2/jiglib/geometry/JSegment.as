...
package jiglib.geometry {
	...
	public class JSegment {
		...
		private function sqrDistanceLine(out : Object, rkLine : JRay, rkBox : JBox, boxState : PhysicsState) : Number {
			...
			var kPnt : Vector3D = new Vector3D(kDiff.dotProduct(orientationCols[0]), kDiff.dotProduct(orientationCols[1]), kDiff.dotProduct(orientationCols[2]));

			var kDir : Vector3D = new Vector3D(rkLine.dir.dotProduct(orientationCols[0]), rkLine.dir.dotProduct(orientationCols[1]), rkLine.dir.dotProduct(orientationCols[2]));
		...
		private function sqrDistancePoint(out : Object, rkPoint : Vector3D, rkBox : JBox, boxState : PhysicsState) : Number {
			...
			var kClosest : Vector3D = new Vector3D(kDiff.dotProduct(orientationVector[0]), kDiff.dotProduct(orientationVector[1]), kDiff.dotProduct(orientationVector[2]));
