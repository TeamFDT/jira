...
package jiglib.physics {
	...
	public class RigidBody {
		...
		public function get rotationX() : Number {
			return _rotationX;
			// (_useDegrees) ? radiansToDegrees(_rotationX) : _rotationX;
		}

		public function get rotationY() : Number {
			return _rotationY;
			// (_useDegrees) ? radiansToDegrees(_rotationY) : _rotationY;
		}

		public function get rotationZ() : Number {
			return _rotationZ;
			// (_useDegrees) ? radiansToDegrees(_rotationZ) : _rotationZ;
		}
