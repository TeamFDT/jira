...
package jiglib.physics {
	...
	public class HingeJoint extends PhysicsController {
		...
		public function HingeJoint(body0 : RigidBody, body1 : RigidBody, hingeAxis : Vector3D, hingePosRel0 : Vector3D, hingeHalfWidth : Number, hingeFwdAngle : Number, hingeBckAngle : Number, sidewaysSlack : Number, damping : Number) {
			_body0 = body0;
			_body1 = body1;
