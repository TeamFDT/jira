...
package jiglib.vehicles {
	...
	public class JCar {
		...
		public function setupWheel(_name : String, pos : Vector3D, wheelSideFriction : Number = 2, wheelFwdFriction : Number = 2, wheelTravel : Number = 3, wheelRadius : Number = 10, wheelRestingFrac : Number = 0.5, wheelDampingFrac : Number = 0.5, wheelNumRays : int = 1) : void {
