...
package net.hires.debug {
	...
	public class Stats extends Sprite {
		private var WIDTH : uint = 105;
		private var HEIGHT : uint = 105;
		...
		protected var theme : Object = {bg:0x000000, fps:0xffff00, ms:0x00ff00, mem:0x00ffff, memmax:0xff0070};
		 ...
		 */
		public function Stats(_theme : Object = null, _width : Number = NaN, _height : Number = NaN) : void {
			...
			if (_theme) {
				...
				if (_theme.width != null) WIDTH = _theme.width;
				if (_theme.height != null) HEIGHT = _theme.height;
			}
		...
		public function startStats() : void {
			addEventListener(Event.ENTER_FRAME, update, false, 0, true);
		}

		public function stopStats() : void {
